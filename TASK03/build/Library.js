...
const BorrowingManagement_1 = require("./Library/BorrowingManagement");
const UserManagement_1 = require("./Library/UserManagement");
const User = new UserManagement_1.UserManagement();
const Book = new BorrowingManagement_1.BorrowingManagement();
